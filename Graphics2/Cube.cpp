...
void Cube::Render()
{
	...
	_deviceContext->PSSetShaderResources(0, 1, _texture3.GetAddressOf());
	...
	completeTransformation = XMLoadFloat4x4(&_worldTransformation2) * viewTransform * projectionTransform;
	cBuffer.CompleteTransformation = completeTransformation;
...
void Cube::BuildGeometryBuffers()
{
	...
	Vertex vertices[] =
	{
		{ XMFLOAT3(-2.0f, -2.0f, 2.0f),  XMFLOAT3(0.0f, 0.0f, 2.0f),  XMFLOAT2(0.0f, 0.0f) },    // side 1
		...
		{ XMFLOAT3(-2.0f, -2.0f, -2.0f), XMFLOAT3(0.0f, 0.0f, -1.0f),  XMFLOAT2(0.0f, 0.0f) },    // side 2
		{ XMFLOAT3(-2.0f, 2.0f, -2.0f),  XMFLOAT3(0.0f, 0.0f, -1.0f),  XMFLOAT2(0.0f, 1.0f) },
		{ XMFLOAT3(2.0f, -2.0f, -2.0f),  XMFLOAT3(0.0f, 0.0f, -1.0f),  XMFLOAT2(1.0f, 0.0f) },
		{ XMFLOAT3(2.0f, 2.0f, -2.0f),   XMFLOAT3(0.0f, 0.0f, -1.0f),  XMFLOAT2(1.0f, 1.0f) },

		{ XMFLOAT3(-2.0f, 2.0f, -2.0f),  XMFLOAT3(0.0f, 2.0f, 0.0f),  XMFLOAT2(0.0f, 0.0f) },    // side 3
		...
		{ XMFLOAT3(-2.0f, -2.0f, -2.0f), XMFLOAT3(0.0f, -2.0f, 0.0f),  XMFLOAT2(0.0f, 0.0f) },    // side 4
		{ XMFLOAT3(2.0f, -2.0f, -2.0f),  XMFLOAT3(0.0f, -2.0f, 0.0f),  XMFLOAT2(0.0f, 1.0f) },
		{ XMFLOAT3(-2.0f, -2.0f, 2.0f),  XMFLOAT3(0.0f, -2.0f, 0.0f),  XMFLOAT2(1.0f, 0.0f) },
		{ XMFLOAT3(2.0f, -2.0f, 2.0f),   XMFLOAT3(0.0f, -2.0f, 0.0f),  XMFLOAT2(1.0f, 1.0f) },

		{ XMFLOAT3(2.0f, -2.0f, -2.0f),  XMFLOAT3(2.0f, 0.0f, 0.0f),  XMFLOAT2(0.0f, 0.0f) },    // side 5
		...
		{ XMFLOAT3(-2.0f, -2.0f, -2.0f), XMFLOAT3(-2.0f, 0.0f, 0.0f),  XMFLOAT2(0.0f, 0.0f) },    // side 6
		{ XMFLOAT3(-2.0f, -2.0f, 2.0f),  XMFLOAT3(-2.0f, 0.0f, 0.0f),  XMFLOAT2(0.0f, 1.0f) },
		{ XMFLOAT3(-2.0f, 2.0f, -2.0f),  XMFLOAT3(-2.0f, 0.0f, 0.0f),  XMFLOAT2(1.0f, 0.0f) },
		{ XMFLOAT3(-2.0f, 2.0f, 2.0f),   XMFLOAT3(-2.0f, 0.0f, 0.0f),  XMFLOAT2(1.0f, 1.0f) },
	};
